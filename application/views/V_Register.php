            ...
            <div class="content-wrapper d-flex align-items-center auth register-bg-1 theme-one">
                <div class="row w-100">
                    <div class="col-lg-4 mx-auto">
                        <div class="auto-form-wrapper">
                            <?= form_open('/Dataadmin/add_new_mua', array('method' => 'post')); ?>
                            <p class="text-center">
                                <img src="<?= assets_url('logoptp4.png', false); ?>" width="135">
                            </p>
                            <h4 style="text-align: center;">REGISTER</h4>
                            <marquee>Selamat Datang di Website Komersial dan Pemasaran PT Pelabuhan Tanjung Priok</marquee>
                            ...
                            <div class="form-group">
                                <label class="label">Link IG</label>
                                <input type="text" name="link_ig" class="form-control" placeholder="link IG">
                            </div>
                            <div class="form-group">
                ...
                <center>
                  <div class="g-recaptcha" data-sitekey="6LftN2IUAAAAALCWS7KvM5zb913HfuR89PeQr04L"></div>
                            ...
                            <div>
                                <a href="<?= base_url("/Auth"); ?>" style="text-align: right;">Back to Login</a>
                            </div>
